...
public class Wall15 {
    ...
    public Wall15() {//constructor1

    }


    public Wall15(double width, double height) {//constructor 2
        this.width=width;
        this.height=height;
    ...
    public void setWidth(double width) {//method wiht 1 parameter of type double
        if (width < 0) {
            this.width = 0;
        } else {
            this.width = width;
